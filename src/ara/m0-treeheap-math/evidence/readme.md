...
description: "ARA 中文读者版：ara/m0-treeheap-math/evidence/README.md"
tags: [ARA, TreeHeap, SPR]
---

> ARA canonical source: `ara/m0-treeheap-math/evidence/README.md`  
> SameTime 中文镜像源: `ara/m0-treeheap-math/evidence/README.zh.md`

# README（中文读者版）

对应英文文件：`ara/m0-treeheap-math/evidence/README.md`  
