---
title: "soft treeheap（中文读者版）"
date: 2026-06-29
weight: 100
author: "nio (Houming818) & Codex Review"
description: "ARA 中文读者版：ara/m0-treeheap-math/logic/soft_treeheap.md"
tags: [ARA, TreeHeap, SPR]
---

> ARA canonical source: `ara/m0-treeheap-math/logic/soft_treeheap.md`  
> SameTime 中文镜像源: `ara/m0-treeheap-math/logic/soft_treeheap.zh.md`

# soft treeheap（中文读者版）

对应英文文件：`ara/m0-treeheap-math/logic/soft_treeheap.md`  
...
本文件定义 Soft TreeHeap：把 hard TreeHeap 操作提升为可微、概率混合的操作族。
