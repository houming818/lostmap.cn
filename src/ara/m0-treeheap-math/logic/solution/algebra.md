...
description: "ARA 中文读者版：ara/m0-treeheap-math/logic/solution/algebra.md"
tags: [ARA, TreeHeap, SPR]
---

> ARA canonical source: `ara/m0-treeheap-math/logic/solution/algebra.md`  
> SameTime 中文镜像源: `ara/m0-treeheap-math/logic/solution/algebra.zh.md`

# algebra（中文读者版）

对应英文文件：`ara/m0-treeheap-math/logic/solution/algebra.md`  
...
本文件说明 TreeHeap 的基础代数工具箱，包括 compose、decompose、projection、inverse-like 操作和概率容器。
