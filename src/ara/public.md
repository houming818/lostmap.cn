...
description: "ARA 中文读者版：ara/PUBLIC.md"
tags: [ARA, TreeHeap, SPR]
---

> ARA canonical source: `ara/PUBLIC.md`  
> SameTime 中文镜像源: `ara/PUBLIC.zh.md`

# PUBLIC（中文读者版）

对应英文文件：`ara/PUBLIC.md`  
所属主题：ARA 根目录
...
本文件说明哪些 ARA 材料可以公开，以及公开时应遵守的边界。
