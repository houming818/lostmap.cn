...
description: "ARA 中文读者版：ara/s2-translation/logic/problem.md"
tags: [ARA, TreeHeap, SPR]
---

> ARA canonical source: `ara/s2-translation/logic/problem.md`  
> SameTime 中文镜像源: `ara/s2-translation/logic/problem.zh.md`

# problem（中文读者版）

对应英文文件：`ara/s2-translation/logic/problem.md`  
