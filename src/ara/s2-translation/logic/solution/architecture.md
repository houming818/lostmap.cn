---
title: "architecture（中文读者版）"
date: 2026-06-29
weight: 300
author: "nio (Houming818) & Codex Review"
description: "ARA 中文读者版：ara/s2-translation/logic/solution/architecture.md"
tags: [ARA, TreeHeap, SPR]
---

> ARA canonical source: `ara/s2-translation/logic/solution/architecture.md`  
> SameTime 中文镜像源: `ara/s2-translation/logic/solution/architecture.zh.md`

# architecture（中文读者版）

对应英文文件：`ara/s2-translation/logic/solution/architecture.md`  
...
本文件说明 S2 架构：L0/L1/L2、fold stack、graph builder、probability container 如何连接。
