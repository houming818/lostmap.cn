...
description: "ARA 中文读者版：ara/s2-translation/logic/solution/theory.md"
tags: [ARA, TreeHeap, SPR]
---

> ARA canonical source: `ara/s2-translation/logic/solution/theory.md`  
> SameTime 中文镜像源: `ara/s2-translation/logic/solution/theory.zh.md`

# theory（中文读者版）

对应英文文件：`ara/s2-translation/logic/solution/theory.md`  
...
本文件说明 S2 的理论背景：为什么要从结构、能量、概率容器角度理解翻译前结构。
